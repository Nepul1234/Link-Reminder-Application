...
const EditLink = () => {
  ...
  useEffect(() => {
    // Mock API call to get link data - replace with actual backend call later
    const mockLinkData = {
      id: id,
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      console.log('Link updated:', { id, ...formData });
      navigate('/dashboard');
      setIsLoading(false);
    }, 1000);
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="text-gray-600">Loading link data...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Update your saved link information
            </p>
          </div>
